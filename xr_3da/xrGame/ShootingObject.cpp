...
void CShootingObject::LoadFireParams(LPCSTR section, LPCSTR prefix)
{
	...
	iHitPower			= pSettings->r_s32		(section,strconcat(sizeof(full_name), full_name,prefix,"hit_power"));
...
void CShootingObject::LoadShellParticles (LPCSTR section, LPCSTR prefix)
{
	...
	if(pSettings->line_exist(section,full_name)) 
	{
		...
		vShellPoint	= pSettings->r_fvector3	(section,strconcat(sizeof(full_name), full_name,prefix,"shell_point"));
	}
}
