...
//	CActorCondition::LoadCondition(section);
	...
	::Sound->create		(sndHit[0],			strconcat(sizeof(buf), buf,*cName(),"\\hurt1"), st_Effect, SOUND_TYPE_MONSTER_INJURING);
	::Sound->create		(sndHit[1],			strconcat(sizeof(buf), buf,*cName(),"\\hurt2"), st_Effect, SOUND_TYPE_MONSTER_INJURING);
	::Sound->create		(sndHit[2],			strconcat(sizeof(buf), buf,*cName(),"\\hurt3"), st_Effect, SOUND_TYPE_MONSTER_INJURING);
	::Sound->create		(sndHit[3],			strconcat(sizeof(buf), buf,*cName(),"\\hurt4"), st_Effect, SOUND_TYPE_MONSTER_INJURING);
